...
public class User implements Serializable {    
	...
	/* Because internally hazel caste or any other cache providers like EH cache will serialize our projects
	 * or models entities to a file system or in memory as required or to a database.
	 * So we should implement the C realizable interface for caching to work hit control one add a default serialization
	 */
